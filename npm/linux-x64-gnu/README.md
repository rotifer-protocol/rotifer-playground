...
Native binding for [`@rotifer/playground`](https://www.npmjs.com/package/@rotifer/playground) — Linux x64 (glibc).

This package is automatically installed as an optional dependency when you install `@rotifer/playground` on Linux x64. You do not need to install it directly.
