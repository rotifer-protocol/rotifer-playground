...
Native binding for [`@rotifer/playground`](https://www.npmjs.com/package/@rotifer/playground) — macOS Intel (x64).

This package is automatically installed as an optional dependency when you install `@rotifer/playground` on macOS x64. You do not need to install it directly.
